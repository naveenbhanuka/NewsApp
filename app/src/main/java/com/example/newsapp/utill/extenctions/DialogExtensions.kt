...
class AlertDialogHelper(context: Context, title: CharSequence?, message: CharSequence?) {
    ...
    private val positiveButton: TextView by lazyFast {
        dialogView.findViewById<TextView>(R.id.dialogInfoPositiveButton)
    }

    private val negativeButton: TextView by lazyFast {
        dialogView.findViewById<TextView>(R.id.dialogInfoNegativeButton)
    }
    ...
    fun positiveButton(@StringRes textResource: Int, func: (() -> Unit)? = null) {
        with(positiveButton) {
            ...
            setClickListenerToDialogText(func)
        }
    }
    ...
    private fun TextView.setClickListenerToDialogText(func: (() -> Unit)?) {
        setOnClickListener {
            func?.invoke()
            dialog?.dismiss()
        }
